...
import { getNormalPath } from '@/utils/sensitive'
...
.tags-view-container {
  ...
  width: 100%;
  background: var(--app-tags-bg, rgba(255, 255, 255, 0.86));
  border-bottom: 1px solid var(--app-navbar-border, var(--tags-item-border, #d8dce5));
  display: flex;
  align-items: center;
  overflow: hidden;
  ...
  $btn-width: 28px;
  $btn-color: #71717a;
  $btn-hover-bg: var(--app-toolbar-hover, #f0f2f5);
  ...
  .tags-view-wrapper {
    ...
    .tags-view-item {
      ...
      &:hover {
        ...
        background: var(--app-toolbar-hover, #f3f6fb);
  ...
  &:not(.tags-view-container--chrome) .tags-view-wrapper .tags-view-item.active {
    background: color-mix(in srgb, var(--tag-active-color, var(--current-color, #409eff)) 18%, var(--app-tags-active-mix, #ffffff) 82%);
    color: var(--tag-active-color, var(--current-color, #409eff));
    border-color: color-mix(in srgb, var(--tag-active-color, var(--current-color, #409eff)) 34%, var(--app-tags-active-mix, #ffffff) 66%);
    box-shadow: 0 4px 12px rgba(46, 109, 210, 0.08);
    font-weight: 600;

    &::before {
      content: '';
      background: var(--tag-active-color, var(--current-color, #409eff));
  ...
  :global(html.dark) & {
    $dark-divider: 1px solid var(--app-navbar-border, var(--el-border-color));

    .tags-nav-btn,
    .tags-action-btn {
      color: var(--el-text-color-secondary);
      border-color: var(--app-navbar-border, var(--el-border-color));
    ...
    .tags-nav-btn--left { border-right: $dark-divider; }
    .tags-nav-btn--right,
    .tags-action-btn { border-left: $dark-divider; }
    ...
    .tags-view-wrapper .tags-view-item {
      ...
      &:hover {
        background: var(--app-toolbar-hover, var(--el-fill-color));
  ...
  &.tags-view-container--chrome {
    --chrome-strip-bg: var(--app-tags-bg, #ffffff);
    --chrome-strip-border: var(--el-border-color-lighter, #e4e7ed);
    --chrome-tab-active-bg: color-mix(in srgb, var(--current-color, #409eff) 18%, var(--app-tags-active-mix, #ffffff) 82%);
    --chrome-tab-text: var(--el-text-color-regular, #606266);
    --chrome-tab-text-active: var(--current-color, #409eff);
    --chrome-wing-r: 10px;
