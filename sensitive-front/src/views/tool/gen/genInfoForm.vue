<template>
  <el-form ref="genInfoForm" :model="info" :rules="rules" label-width="150px">
    <el-row>
      <el-col :span="12">
        <el-form-item prop="tplCategory">
          ...
          <el-select v-model="info.tplCategory" @change="tplSelectChange">
            ...
            <el-option label="主子表（详情页）" value="subDetail" />
          </el-select>
        </el-form-item>
      </el-col>
      ...
      <el-col :span="12">
        <el-form-item prop="packageName">
          <template #label>
            生成包路径
            <el-tooltip content="生成在哪个java包下，例如 com.sensitive.system" placement="top">
    ...
    <template v-if="info.tplCategory == 'sub' || info.tplCategory == 'subDetail'">
