package com.sensitive.generator.util;
...
public class VelocityUtils
{
    ...
    public static VelocityContext prepareContext(GenTable genTable)
    {
        ...
        if (GenConstants.TPL_SUB.equals(tplCategory) || GenConstants.TPL_SUB_DETAIL.equals(tplCategory))
        {
    ...
    public static List<String> getTemplateList(GenTable table)
    {
        ...
        {
            templates.add(useWebType + "/index.vue.vm");
            templates.add(useWebType + "/detail.vue.vm");
            templates.add("vm/java/sub-domain.java.vm");
        }
        if (isView)
        {
    ...
    public static String getFileName(String template, GenTable genTable)
    {
        ...
        if (template.contains("sub-domain.java.vm") && (StringUtils.equals(GenConstants.TPL_SUB, genTable.getTplCategory())
                || StringUtils.equals(GenConstants.TPL_SUB_DETAIL, genTable.getTplCategory())))
        {
